      ...
      return(
        ...
        <Grid className={classes.stagecenter}>
          ...
          <Grid className={classes.stagePaddingLeft}>
            <AnchorLink href={tag} offset="75" style={{color:"#114B5F"}}>
              {stageTitle}
            </AnchorLink>
          </Grid>
        </Grid>
        ...
        <Grid className={classes.stagecenter}>
          <img src="/img/pages/skall.png" alt="" width="15"/>
          <Grid className={classes.stagePaddingLeft}>
            <AnchorLink href={tag} offset="85" style={{color:"#114B5F"}}>
              {stageTitle}
            </AnchorLink>
          </Grid>
        </Grid>
      ...
      <div className={classes.root}>
        ...
        <main>
          ...
          <div>
            <Grid className={classes.center}>
              <Grid item>
                <img src="/img/pages/Menu/hotzone.png" alt="" width="30" height="32"/>
              </Grid>
              <Grid item>
                <ResponsiveFontProvider>
                  <Typography variant="h5" className={classes.title}>ホットゾーン</Typography>
                </ResponsiveFontProvider>
              </Grid>
              <Grid item>
                <img src="/img/pages/Menu/hotzone.png" alt="" width="30" height="32"/>
...
export default function P4HotZone() {
  return (
    <Page/>
  )
};
