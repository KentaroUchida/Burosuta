      ...
      return(
        ...
        <Grid className={classes.stagecenter}>
          ...
          <Grid className={classes.stagePaddingLeft}>
            <AnchorLink href={tag} offset="75" style={{color:"#303036"}}>
              {stageTitle}
            </AnchorLink>
          </Grid>
        </Grid>
        ...
        <Grid className={classes.stagecenter}>
          <img src="/img/pages/skall.png" alt="" width="15"/>
          <Grid className={classes.stagePaddingLeft}>
            <AnchorLink href={tag} offset="85" style={{color:"#303036"}}>
              {stageTitle}
            </AnchorLink>
          </Grid>
        </Grid>
      ...
      <div className={classes.root}>
        ...
        <main>
          ...
          <div>
            <Grid className={classes.center}>
              <Grid item>
                <img src="/img/pages/Menu/suppression.png" alt="" width="33"/>
              </Grid>
              <Grid item>
                <ResponsiveFontProvider>
                  <Typography variant="h5" className={classes.title}>制圧</Typography>
                </ResponsiveFontProvider>
              </Grid>
              <Grid item>
                <img src="/img/pages/Menu/suppression.png" alt="" width="33"/>
